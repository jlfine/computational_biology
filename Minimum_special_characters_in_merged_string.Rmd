...
To solve this, we may consider the boundary condition when there exist no unique special characters in either k-mer, implying that $P_1,P_2 =0$. This occurs only when all the special characters are found in the overlapping region of length $k$, so in this case, we have that $k=\rho=p$. We therefore obtain that

$$\ell_{min}(\rho=k=p,P_1=0,P_2=0) = \frac{p}{2l -p}$$

This is the minimum value of $\ell$.
...
As can be seen, the argmin occurs when $\rho = k = p = 8$, as was the case here (recalling that $p = 8$ in this example). This is consistent with our analytical solution.
